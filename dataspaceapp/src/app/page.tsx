    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-12 text-center text-white shadow-xl">
          ...
          <Link
            href={authLoading ? "#" : user ? "/search" : "/?login=1&next=%2Fsearch"}
            aria-disabled={authLoading}
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all disabled:pointer-events-none disabled:opacity-60"
            onClick={(e) => {
              if (authLoading) {
                e.preventDefault()
              }
