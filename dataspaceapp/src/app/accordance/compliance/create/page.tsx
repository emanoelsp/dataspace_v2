...
const steps = [
  ...
  { id: 2, title: "Declaração", icon: BookOpen },
  { id: 3, title: "Assinatura & Registro", icon: FileSignature },
]
        ...
        return (
          <>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
              ...
              Step 2: Declaração de Conformidade
            </h2>
            <p className="text-gray-600 mb-6">
              Selecione a base legal do tratamento de dados e defina os termos de acesso — a declaração
              é registrada em um único passo.
            </p>
      ...
      case 3:
        return (
          <>
            ...
            <p className="text-gray-600 mt-6 mb-4 text-sm">Confira a declaração antes de registrar:</p>
            <div className="bg-white p-8 rounded-lg border border-gray-300 shadow-lg mb-8 font-serif text-gray-900 max-w-2xl mx-auto">
              ...
              <section className="mb-6">
                <h2 className="font-semibold text-lg mb-1">4. Consent Logs (automático)</h2>
                <p className="text-sm text-gray-600">Gerados pelo plano de controle: aceites de contrato e logs de acesso do Sidecar PEP.</p>
              </section>
              <section className="mb-6">
                <h2 className="font-semibold text-lg mb-1">5. Assinatura Digital</h2>
