...
export default function RouteGuard({ children }: { children: ReactNode }) {
  ...
  if (!user) {
    ...
    const loginHref = `/?login=1&next=${encodeURIComponent(next)}`
    return (
      <GuardMessage
        title="Sign in required"
        description="This area requires an authenticated participant. Sign in to continue."
  ...
  if (!role) {
    return (
      <GuardMessage
        ...
        description="Complete your participant profile to access this area."
        primaryHref="/profile"
